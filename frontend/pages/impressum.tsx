            ...
            <div className="p-8 lg:p-12">
              <div className="prose prose-lg max-w-none">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-gray-700">
                          <div className="flex items-center gap-2">
                            ...
                            <a href="mailto:legal@castlumen.com" className="text-blue-600 hover:text-blue-800">
                              legal@castlumen.com
                            </a>
                          </div>
                          <div className="flex items-center gap-2">
                ...
                <section className="mb-12">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    <p className="text-gray-700">
                      <strong>Max Mustermann</strong> (Geschäftsführer)<br/>
                      <strong>Anna Schmidt</strong> (Geschäftsführerin)
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      <h3 className="font-semibold text-gray-900 mb-3">Handelsregister</h3>
                      <p className="text-gray-700">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      <h3 className="font-semibold text-gray-900 mb-3">Umsatzsteuer-ID</h3>
                      <p className="text-gray-700">
                        DE123456789<br/>
                        <span className="text-sm text-gray-500">gemäß §27a UStG</span>
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <div className="flex items-center justify-between text-sm text-gray-500">
                    <span>Letzte Aktualisierung: 13. September 2025</span>
